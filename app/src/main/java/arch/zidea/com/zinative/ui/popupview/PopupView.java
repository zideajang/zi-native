...
public class PopupView extends PopupWindow {
    ...
    public void show(View anchor, Rect frame, Point origin){
        ...
        if(frame == null) frame = new Rect(); //视图框架
        ...
        //获取偏移点 react y + height(父级底部位置) +
        Point offset = getOffset(frame, new Rect(x, y + height, contentWidth + x,contentHeight + y + height),
    ...
    public void showAtRight(View anchor, Point orgin, int xOff, int yOff){
        showAsDropDown(anchor,xOff, yOff);
    }
